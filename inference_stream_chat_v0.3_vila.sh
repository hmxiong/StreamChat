...
MODEL_NAME=VILA_Streaming
CHUNK_SIZE=20
OURS_EGO=/13390024681/llama/EfficientVideo/Ours/output/${MODEL_NAME}/result_test_streaming_fast_v0.3_0.2rate_chunk_size_${CHUNK_SIZE}.json
...
mkdir /13390024681/llama/EfficientVideo/Ours/output/${MODEL_NAME}

CUDA_VISIBLE_DEVICES=0,1 python inference_streaming_vila_offline.py \
                    --model_name /13390024681/All_Model_Zoo/Llama-3-VILA1.5-8B \
