...
def test_memory():
    ...
    # llm_client = LLMClientLLaMA3(gen_config=config, model_name='/All_Model_Zoo/llama3-8b-instruct-hf')
    ...
    # memory_dir = '/llama/EfficientVideo/Ours/memory_bank/memories.json'
    ...
    if user_name in memory.keys():
        if input('Would you like to summarize your memory? If yes, please enter "yes"') == "yes":
            ...
            config = {'max_tokens':1024, 'temperature':1, 'top_p':0.95, 'frequency_penalty':True}
            llm_client = LLMClientLLaMA3(gen_config=config, model_name='/All_Model_Zoo/chatglm3-6b')
...
def test_eval_metrics():
    ...
    model_path = '/All_Model_Zoo/LLaVA-NExT-LLaMA3-8B'
    model_base = None
    model_name = 'llava_next_llama3'
    conv_mode = 'llava_llama_3'
    video_path = '/llama/EfficientVideo/Ours/videos/1.mp4'
...
def test_embedding():
    ...
    # 1. load model
    model_id = '/All_Model_Zoo/mxbai-colbert-large-v1'
...
def simulate_memory_construct():
    ...
    print("Ready models")
    embedding_model_id = '/All_Model_Zoo/mxbai-colbert-large-v1'
