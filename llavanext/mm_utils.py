...
def select_best_resolution(original_size, possible_resolutions):
    ...
    """
    print("original size for select best :{}".format(original_size))
...
def process_anyres_image(image, processor, grid_pinpoints):
    ...
    # print("len image patches:{}".format(len(patches))) # 4
    ...
    # print("image patchs :{}".format(image_patches))
...
def process_images(images, image_processor, model_cfg):
    ...
    if image_aspect_ratio == "highres":
        ...
        for image in images:
            ...
            new_images.append(image) # 1
    elif image_aspect_ratio == "crop_split":
        for image in images:
            image = process_highres_image_crop_split(image, model_cfg, image_processor)
            new_images.append(image) # [num_paths dim resize_w resize_h]
