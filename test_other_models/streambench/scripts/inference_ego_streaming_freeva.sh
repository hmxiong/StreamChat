CKPT_NAME="FreeVA-7B"
model_path="/13390024681/All_Model_Zoo/llava-v1.5-7b"
cache_dir="./cache_dir"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
  CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python3 /13390024681/llama/EfficientVideo/Ours/test_other_models/inference_ego_streaming_freeva.py \
