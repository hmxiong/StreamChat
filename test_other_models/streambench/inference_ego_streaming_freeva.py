...
from freeva.conversation import conv_templates, SeparatorStyle
from freeva.constants import DEFAULT_IM_START_TOKEN, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_INDEX
from freeva.mm_utils import get_model_name_from_path, tokenizer_image_token, KeywordsStoppingCriteria
from freeva.mm_utils import tokenizer_image_token, process_images, get_model_name_from_path
from freeva.model.builder import load_pretrained_model
...
def run_inference(args):
    ...
    for sample in tqdm(gt_questions, desc="FreeVA Inference for:{}".format(mode)):
        ...
        for ques_sample in tqdm(sample['breakpoint'], desc="FreeVA Inference for:{}".format(mode)):
            ...
            if os.path.exists(temp_path):
                ...
                video_frame, video_size = load_video(video_path, num_frm=4)
