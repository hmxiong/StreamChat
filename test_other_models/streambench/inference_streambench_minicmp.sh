CKPT_NAME="MiniCMP_v2_6"
model_path="/13390024681/All_Model_Zoo/MiniCPM-V-2_6"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
  CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python3 /13390024681/llama/EfficientVideo/Ours/test_other_models/streambench/inference_streaming_minicmp.py \
