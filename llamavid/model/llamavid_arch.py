...
class LLaMAVIDMetaForCausalLM(ABC):
    ...
    def token_generation(self, text_q, vis_embed, long_video=False):
        ...
        # print("original visual embedding :{}".format(vis_embed.shape))
        ...
        # print("vis embedding after stage 2:{}".format(vis_embed.shape))
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        # print("video shape:{}".format(images[0].shape))
        if images[0].shape[-1] > 1000:
            # print("This video is long frame !!")
            long_video = True
        else:
            # print("This video is not long frame !!")
            long_video = False
