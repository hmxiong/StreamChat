...
# question_list =[
#             {
#                 "question": "I want to discard the trash in my hand; do you remember where the trash can is located?",
#                 "answer": "The trash can is in a corner of the kitchen, leaning against a white wall.",
#                 "time": 25
#             },
#             {
#                 "question": "I want to heat the butter in my hand using the microwave; do you know where the microwave is?",
#                 "answer": "It is on your right side, next to the stove.",
#                 "time": 57
#             },
#             {
#                 "question": "I want to record on sticky notes the ingredients I need to purchase for cooking tomorrow. Can you help me find where to find sticky notes in this kitchen?",
#                 "answer": "There are several notes or labels attached to the refrigerator door that are attached with magnets or small clips which appears to be reminders or shopping lists.",
#                 "time": 87
#             },
#             {
#                 "question": "Can you tell me some of the benefits of drinking a glass of hot milk before going to bed?",
#                 "answer": "It can soothes your body and mind, offer you better sleep.",
#                 "time": 116
#             },
#             {
#                 "question": "Where in the kitchen are the spices I need to cook?",
#                 "answer": "There may be the spices you want on the wooden cabinet next to the refrigerator not far from you.",
#                 "time": 155
#             },
#             {
#                 "question": "Where is the trash in the kitchen?",
#                 "answer": "It is still in a corner of the kitchen, near the sink.",
#                 "time": 180
#             }
...
def updating_memory_buffer(update_event, start_inference_event, video_reader_event,  summarizer_model, summarizer_tokenzier, building_multi_modal_memory_tree):
    """
...
def video_reader_thread_with_embedding(cap, total_frames, frame_rate, image_processor, model, count, video_reader_event, update_event):
    """
...
def inference_thread_with_memory_and_dialogue_retrival_test(start_inference_event, fps, model, embedding_model, tokenizer, embedding_tokenizer, image_processor, num_frames, conv_mode, pause_event, update_event, chat, memory_config, args, current_frame, save_file, output_loss=False):
    """
...
def run_inference(args):
    ...
    if inference_mode == "on_line":
        ...
        video_thread = threading.Thread(target=video_reader_thread_with_embedding, args=(cap, total_frames, frame_rate, image_processor, model, current_frame, video_reader_event, update_event))
        ...
        update_thread = threading.Thread(target=updating_memory_buffer, args=(update_event, start_inference_event, video_reader_event, model, tokenizer, args.multi_modal_memory))
        # video_thread = threading.Thread(target=video_reader_thread, args=(cap, frame_queue, total_frames, frame_rate))
        
        # Start the inference thread
        infer_thread = threading.Thread(target=inference_thread_with_memory_and_dialogue_retrival_test, args=(start_inference_event, frame_rate, model, embedding_model,  tokenizer, embedding_tokenizer, image_processor, args.num_frames, args.conv_mode, pause_event, update_event, chat, memory_config, args, current_frame, save_file, args.ppl))
